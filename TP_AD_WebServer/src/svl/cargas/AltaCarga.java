...
public class AltaCarga extends GenericHttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			Date fechaMax = request.getParameter("fechaMaxEntrega") != null ? DateUtils.parseWebDate(request.getParameter("fechaMaxEntrega")) : null;
			...
			CargaView carga = new CargaView(tipoCarga, DateUtils.invParseDate(fechaMax), null, manifiesto, null, destino, null, productos, retira);
			
			Integer id = BusinessDelegate.getInstance().getInterfaz().altaCarga(idSucOrigen, idCliente, carga, !local);
			String fechaProbable = DateUtils.invParseDate(BusinessDelegate.getInstance().getInterfaz().fechaProbableLlegada(id));
